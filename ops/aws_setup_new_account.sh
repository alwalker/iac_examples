...
aws dynamodb create-table --table-name terraform-states-outline-eks-prod --attribute-definitions $DYNAMODB_ATT --key-schema $DYNAMODB_KEY --provisioned-throughput ReadCapacityUnits=5,WriteCapacityUnits=5
